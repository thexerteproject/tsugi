# Xerte fork of the TSUGI project

This fork is intended to be used by the [GitHub thexerteproject/xertetoolkits](https://github.comt/hexerteproject/xerteonlinetoolkits) project. It does not follow master at regular intervals, but will provide backported fixes, such as the change required by Canvas, to previous versions/branches/tags for older versions of PHP. These will be used by the setuptsugi TSUGI installer of Xerte Online Tookits. When master is required setuptsugi will always use the official repository of [TSUGI](https://github.com/tsugiproject/tsugi) instead of this fork.
